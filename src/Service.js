  ...
  return (
    <div className="service component__space" id="Services">
      ...
      <div className="container">
        <div className="row">
          <div className="col__3" style={{marginLeft:"7%"}}>
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">Data Structures And Algorithms</h1>
         ...
         <div className="col__3" >
          ...
          <div className="col__3" style={{marginLeft:"7%"}}>
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">BetaTester Intern</h1>
                <p className="p service__text p__color">
                  I throw myself down among the
                </p>
                <p className="p service__text p__color">
          ...
          <div className="col__3" >
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">DCC(coding club) member</h1>
                <p className="p service__text p__color">
                  I throw myself down among the
                </p>
                <p className="p service__text p__color">
